<?php
    ...
    <?php
        ...
        $request['email'] = $_POST['friendCode'];
...
<h2>User: <?php echo "<b>$profileEmail</b>";?></h2>
    ...
    <div>
        <?php
            ...
            $request = array();
            $request['type'] = "getProfileLikes";
            $request['email'] = $_POST['friendCode'];
            $request['message'] = "getProfileLikes";
        ...
        <?php
            ...
            $request = array();
            $request['type'] = "getProfileDislikes";
            $request['email'] = $_POST['friendCode'];
            $request['message'] = "getProfileDislikes";
